...
public interface PlanRepo extends JpaRepository<Plan, Long> {
    ...
    @Query("select new tech.getarrays.inventorymanager.wrapper.PlanWrapper(u.name , u.description , u.code , u.price , u.duration , u.status) from Plan u where u.id=:id")
